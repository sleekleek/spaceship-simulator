...
chibi_indices, chibi_buffer = ObjLoader.load_model("data/earth/Model.obj")
monkey_indices, monkey_buffer = ObjLoader.load_model("data/saturn/Model.obj")
...
load_texture("data/earth/Texture.jpg", textures[0])
load_texture("data/saturn/Texture.jpg", textures[1])
